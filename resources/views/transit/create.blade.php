            ...
            <div class="col-12 col-md-6 col-lg-5 mx-auto login-row">
                <div class="row h-100">
                    <div class="col-12 align-self-center">
                        <h2 class="font-weight-light mb-5 text-center"><small class="font-weight-light">Selamat Datang</small>,<br><span class="text-mute">Form Tambah Data Tempat Transit</span></h2>
                        <form action="{{route('transit.store')}}" method="post">
                            @csrf
                            @include('layouts.error')
                            <div class="form-group float-label mb-2 ">
                                <input type="text" name="tempat_transit" id="tempat_transit" class="form-control" autofocus>
